  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Viewport
        ...
        data-modal={modal}
        className="pointer-events-none fixed inset-0 z-50 select-none data-open:pointer-events-auto data-ending-style:pointer-events-none"
      >
        <DrawerPrimitive.Popup
          ...
          className={cn(
            ...
            // Sizing.
            "[--drawer-content-height:var(--drawer-height,auto)] data-[swipe-axis=x]:[--drawer-content-width:75%] data-[swipe-axis=y]:[--drawer-content-max-height:calc(100dvh-var(--app-safe-top,0px)-1.5rem)] data-[swipe-axis=y]:data-snap-points:[--drawer-content-height:100dvh] data-[swipe-axis=x]:sm:[--drawer-content-width:24rem]",
            // Stack.
